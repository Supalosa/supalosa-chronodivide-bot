...
export class SquadExpansion implements SquadBehaviour {
    public getDesiredComposition(gameApi: GameApi, playerData: PlayerData, squad: Squad, threatData: GlobalThreat | undefined): {unitName: string, priority: number, amount: number}[] {
